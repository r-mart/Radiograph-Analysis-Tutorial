...
def calculate_mAP(det_boxes, det_labels, det_scores, true_boxes, true_labels, cfg):
    """
    ...
    average_precisions = {
        cfg.label_dict[c + 1]: v for c, v in enumerate(average_precisions.tolist())}
